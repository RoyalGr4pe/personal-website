			...
			{steps.map((step, index) => (
				<div
					...
					className={`relative text-md leading-7 shadow-md
						...
						${index % 2 === 0 ? "border-r-4 border-y-4" : "border-l-4"} 
						`}
					style={{
